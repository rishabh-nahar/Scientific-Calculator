    ...
    public class Scientific {
        public static void main(String srgs[]) {
            Sc_Calculatorr obj = new Sc_Calculatorr();
            obj.setVisible(true);
            obj.setSize(400, 400);
    ...
    class Sc_Calculatorr extends JFrame implements ActionListener {
        ...
        */
        ...
        void isEqualto_func() {
            ...
            start_main_array.addAll(main_array);
            ...
            while (main_array.size() > 1) {
                if (main_array.contains("(") && main_array.contains(")")) {
                    ...
                    System.out.println("\nFirst brack: "+first_brack+"\nLast brack: "+last_brack+"\n");
                    ...
                    if (first_brack == last_brack) {
                        ...
                        System.out.println("Error First bracket is just ahead of last bracket");
                        main_array.remove(first_brack);
                        main_array.remove(last_brack);
                    } 
                    else {
                        System.out.println("\nFirst brack: "+first_brack+"\nLast brack: "+last_brack+"\n");
                        auto_multiplly();
